...
#### Special
Commands that let you do certain things in the query.
<table border="1">
    <tr>
       <td><strong>BREAKQUERY</strong></td>
       <td width="100%">No matter where it is used in the query, the query will not work at all.</td>
    </tr>
</table>
